...
namespace LrcMusicPlayer
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnFileActivated(FileActivatedEventArgs args) {
            PlayList list = await PlayList.LoadFromFile(args.Files[0] as StorageFile);
            if (MainPage.Playlist == null) MainPage.Playlist = list;
            else list.CopyTo(MainPage.Playlist);
